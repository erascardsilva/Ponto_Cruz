const fileInput = document.getElementById('fileInput');
      ...
      if (file) {
        ...
        reader.onload = function(e) {
          ...
          img.onload = function() {
            ...
            crossStitchCtx.clearRect(0, 0, crossStitchCanvas.width, crossStitchCanvas.height);
    ...
    function processImage() {
      ...
      crossStitchCtx.fillRect(0, 0, crossStitchCanvas.width, crossStitchCanvas.height);
